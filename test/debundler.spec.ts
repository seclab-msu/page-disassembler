...
function debundlerWrapper(filename: string): Debundler {
    ...
    debundler.debundle(fs.readFileSync(filename, "utf8"), filename);
    return debundler;
}
...
describe("Tests for debundle-file mode", () => {
    describe("webpack-jsonp class", () => {
        ...
        it("webpackJSONP_1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
        ...
        it("webpackJSONP_2", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_2.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_3", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_3.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_4", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_4.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_5", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_5.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_6", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_6.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_7", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_7.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_8", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_8.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
        ...
        it("webpackJSONP_9", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpackJSONP_9.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-bundle"
            );
    ...
    describe("browserify class", () => {
        ...
        it("browserify1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "browserify1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal("broserify-bundle");
            const modules = debundler.getModules();
            expect(modules.size).to.be.above(0);
        });
    ...
    describe("webpack-jsonp-func class", () => {
        ...
        it("webpack-jsonp-func1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-jsonp-func1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
        ...
        it("webpack-jsonp-func2", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-jsonp-func2.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-func-bundle"
            );
        ...
        it("webpack-jsonp-func3", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-jsonp-func3.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-func-bundle"
            );
        ...
        it("webpack-jsonp-func4", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-jsonp-func4.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-jsonp-func-bundle"
            );
    ...
    describe("webpack-runtime-preprocess-func class", () => {
        const CLASS_DIRNAME =
            TEST_DATA_DIRNAME + "webpack-runtime-preprocess-func/";
    ...
    describe("webpack-runtime class", () => {
        ...
        it("webpack-runtime1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
        ...
        it("webpack-runtime2", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime2.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-bundle"
            );
        ...
        it("webpack-runtime3", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime3.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-bundle"
            );
        ...
        it("webpack-runtime4", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime4.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-bundle"
            );
        ...
        it("webpack-runtime5", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime5.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-bundle"
            );
        ...
        it("webpack-runtime6", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime6.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-bundle"
            );
        ...
        it("webpack-runtime7", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime7.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-bundle"
            );
    ...
    describe("webpack-runtime-preprocess-func class", () => {
        ...
        it("webpack-runtime-remote1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-runtime-remote1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-runtime-remote-bundle"
            );
        });
    });
    ...
    describe("webpack-simple class", () => {
        ...
        it("webpack-simple1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
        ...
        it("webpack-simple2", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple2.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-bundle"
            );
        ...
        it("webpack-simple3", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple3.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-bundle"
            );
        ...
        it("webpack-simple4", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple4.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-bundle"
            );
    ...
    describe("webpack-simple-dev class", () => {
        ...
        it("webpack-simple-dev1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple-dev1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
        ...
        it("webpack-simple-dev2", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple-dev2.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-dev-bundle"
            );
        ...
        it("webpack-simple-dev3", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple-dev3.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-dev-bundle"
            );
        ...
        it("webpack-simple-dev4", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple-dev4.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-dev-bundle"
            );
    ...
    describe("webpack-simple-no-import class", () => {
        ...
        it("webpack-simple-no-import1", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple-no-import1.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-no-import-bundle"
            );
            const modules = debundler.getModules();
            expect(modules.size).to.be.above(0);
        });
        ...
        it("webpack-simple-no-import2", () => {
            const debundler = debundlerWrapper(
                CLASS_DIRNAME + "webpack-simple-no-import2.js"
            );
            expect(debundler.getCurBundleClass()).to.equal(
                "webpack-simple-no-import-bundle"
            );
